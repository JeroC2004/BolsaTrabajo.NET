namespace Domain.Model
{
    public class Oferta
    {
        ...
        public Oferta(int id, string titulo, string tipoVinculo, DateTime fechaDesde, DateTime fechaHasta,
                       string detalle, string requisitos, string estado, int empresaId, int tipoOfertaId)
        {
            SetId(id);
            SetTitulo(titulo);
        ...
        public void SetTipoVinculo(string tipoVinculo)
        {
            if (string.IsNullOrWhiteSpace(tipoVinculo))
                throw new ArgumentException("El tipo de vínculo no puede ser nulo o vacío.", nameof(tipoVinculo));
